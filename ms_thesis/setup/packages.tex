...
\usepackage{pdflscape} % Provides the lanscape environment for landscape tables
...
pdfauthor=Shreya Kapoor, % Optional: Specify the author of the pdf
pdftitle=Extracting most predictive subgraphs from models of human brain connectivity   % Optional: Specify the title within the pdf
} 

\usepackage{tcolorbox}
\usepackage{csvsimple}
%\usepackage[acronym,nomain]{glossaries}
\usepackage[toc,nopostdot,description,nonumberlist,style=long,automake,acronym]{glossaries}
%\usepackage[toc,nopostdot,style=long,automake,acronym]{glossaries}
...
%\usepackage[captialise]{cleveref}
